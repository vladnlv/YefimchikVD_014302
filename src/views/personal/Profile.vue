...
<!--                                            <div class="d-inline text-nowrap ms-2 p-2 alert alert-info fw-bold fst-italic" style="text-align: left; width: fit-content">Сумма {{ order.total_price }} BYN</div>-->
                                        ...
                                        <div class="d-flex">
                                            <div v-for="orderProduct in order.products" class="card mx-2 mb-3">
                                                ...
                                                <div class="p-2">
                                                    ...
                                                    <p>{{ orderProduct.price }} BYN x {{ orderProduct.qty }}: {{ orderProduct.price * orderProduct.qty }} BYN</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column">
...
export default {
    ...
    methods: {
        ...
        getOrders() {
            ...
            axios.post('http://shop2511/api/orders', {
