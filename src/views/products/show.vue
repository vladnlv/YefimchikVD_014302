                ...
                <div class="card border border-0 cart-card col-3 h-100 p-4 product-page__aside">
                    ...
                    <div class="d-flex justify-content-between">
                        <h3 class="card-text text-minor fw-bold">
                            {{ product.price.slice(0, -3) }}<span class="ms-2 d-inline text-minor">BYN</span>
                        </h3>
...
export default {
    ...
    methods: {
        ...
        getProduct(id) {
            axios.get(`http://shop2511/api/products/${id}`).then(response => {
                this.loaded = true
        ...
        getReviews() {
            axios.post('http://shop2511/api/reviews', {product_id:this.$router.currentRoute._value.params.id})
                .then((response) => {
        ...
        storeReview() {
            axios.post('http://shop2511/api/review', this.storeReviewData)
                .then((response) => {
        ...
        getUserReview(id) {
            axios.post('http://shop2511/api/review/check', {
        ...
        getSameProducts() {
            ...
            axios.post('http://shop2511/api/products', {
